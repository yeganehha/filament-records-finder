function n() {
    return {
        ...
        init: function () {
            ...
            console.log(this.selectedRecords , 'aaaaaa');
            ...
            }), this.$nextTick(() => this.watchForCheckboxClicks()), Livewire.hook("element.init", ({component: e}) => {
        ...
        getRecordsInGroupOnPage: function (e) {
            let t = [];
            for (let s of this.$root?.getElementsByClassName("fi-ta-record-checkbox") ?? []) s.dataset.group === e && t.push(s.value);
            return t
        },
        ...
        watchForCheckboxClicks: function () {
            this.checkboxClickController && this.checkboxClickController.abort(), this.checkboxClickController = new AbortController;
        ...
        handleCheckboxClick: function (e, t) {
            ...
            if (e.shiftKey) {
                ...
                let o = s.indexOf(this.lastChecked), r = s.indexOf(t), l = [o, r].sort((i, d) => i - d), c = [];
